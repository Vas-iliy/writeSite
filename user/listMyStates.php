...
FROM states JOIN registrations USING (id_login) JOIN cats USING (id_cat) WHERE id_login = '$id'");
...
<div class="container">
    ...
    <blockquote class="blockquote text-center p-3 mb-2 bg-info text-white">
        <p class="mb-0">Здесь отображается список всех ваших статей.</p>
    </blockquote>
            ...
            <div class="card mt-2" style="width: 30rem;">
                ...
                <div class="card-body">
                    ...
                    <div class="card-footer text-right">
                        <a href="redactorState.php?id=<?=$st['id_state']?>" class="btn btn-primary">Редактировать</a>
                    </div>
